...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Low-memory smoke test for blip + textvqa with a chosen attribution method."
    )
    parser.add_argument(
        "--repo_root",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Which BLIP attribution method to run for the smoke test.",
    )
    parser.add_argument(
        "--python",
    ...
    result_file = results_dir / f"blip-textvqa-{args.method}.json"
